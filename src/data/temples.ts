...
export const TEMPLE_DATA: Temple[] = [
  {
    ...
    state: "Uttar Pradesh",
    district: "Varanasi",
    category: ["Jyotirlinga", "Shakti Peetha Circuit", "Ancient"],
    deity: "Lord Shiva (Vishwanath)",
    tradition: "Shaiva · Kashi Shaiva Parampara",
    image: "/images/kashi-vishwanath-temple.jpg",
    rating: "4.9",
    established: "c. 1780 CE (present structure by Ahilyabai Holkar)",
    trust: "Shri Kashi Vishwanath Temple Trust",
    summary:
      "One of the twelve Jyotirlingas, the Vishwanath Temple stands on the western ghats of the Ganga in the eternal city of Kashi — the spiritual capital of India.",
    history: [
    ...
    significance: [
      "Jyotirlinga — self-manifested pillar of light",
      "Mukti-kshetra: darshan is believed to grant liberation",
      "Central to the Panchakroshi Yatra of Kashi",
      "Mentioned in Skanda, Shiva and Padma Puranas",
    ],
    divineAttractions: [
      "Kashi Vishwanath Jyotirlinga darshan",
      "Ganga sunrise boat ride and ghat worship",
      "Dashashwamedh Ganga Aarti",
      "Kashi Vishwanath Dham corridor",
      "Annapurna and Kaal Bhairav sacred circuit",
    ],
    scripturalConnections: [
      {
        title: "Skanda Purana",
        context:
          "Kashi is celebrated in the Kashi Khanda tradition as an Avimukta kshetra associated with Shiva and liberation.",
      },
      {
        title: "Jyotirlinga tradition",
        context:
          "Kashi Vishwanath is traditionally revered as one of Shiva's twelve Jyotirlingas.",
      },
    ],
    pilgrimExperience: [
      "Mangala Aarti / early darshan",
      "Ganga snan or respectful river darshan",
      "Panchakroshi / local temple circuit",
      "Evening Ganga Aarti",
    ],
    bhagavataConnection: [
      "Kashi's wider sacred geography brings Shaiva, Vaishnava and Shakta shrines into one pilgrimage landscape.",
    ],
    sources: [
      {
        title: "Official Temple Information",
        organization: "Shri Kashi Vishwanath Temple",
        url: "https://www.shrikashivishwanath.org/",
        type: "Official Temple",
        purpose:
          "Temple history, darshan, aarti, rituals and pilgrim services.",
    ...
    aarti: [
      {
        name: "Mangala Aarti",
        time: "3:00 AM",
        desc: "Pre-dawn awakening of the Lord with Vedic chanting. Ticketed, limited entry.",
      },
      {
        name: "Saptarishi Aarti",
        time: "7:00 PM",
        desc: "Seven archakas perform aarti in the Vedic Saptarishi tradition — the most celebrated daily aarti.",
      },
      {
        name: "Shringar Bhog Aarti",
        time: "8:00 PM",
        desc: "Evening adornment and bhog offering with bhajans.",
      },
    ],
    festivals: [
      {
        name: "Mahashivratri",
        month: "Feb / Mar",
        desc: "The grandest celebration — lakhs of devotees; the sanctum remains open through the night.",
      },
      {
        name: "Dev Deepawali",
        month: "Nov",
        desc: "The ghats blaze with a million diyas celebrating Shiva's victory over Tripurasura.",
      },
      {
        name: "Shravan Maas",
        month: "Jul / Aug",
        desc: "Monday crowds offer Ganga-jal; Kanwariya pilgrims arrive on foot.",
      },
    ],
    facilities: [
      "Wheelchair assistance & senior-citizen lane",
      "Free locker & shoe stands",
      "Prasad & annakshetra counters",
      "Ganga-view corridor & waiting halls",
      "Medical aid post",
      "CCTV-monitored premises",
      "Multilingual helpdesk (Hindi, English, Tamil, Telugu)",
      "Online Sugam Darshan booking counter",
    ],
    howToReach: [
      {
        mode: "Air",
        detail:
          "Lal Bahadur Shastri Airport (25 km). Prepaid taxis to Godowlia / Corridor gate.",
      },
      {
        mode: "Rail",
        detail: "Varanasi Junction (4 km) & Banaras station (7 km).",
      },
      {
        mode: "Road",
        detail:
          "Well connected via NH-19. E-rickshaws ply to the corridor gates; the sanctum zone is pedestrian-only.",
      },
    ],
    committee: [
      { name: "Chief Executive Officer", role: "Temple Trust Administration" },
      { name: "Head Archaka", role: "Garbhagriha Rituals" },
      { name: "Dharmarth Karya In-charge", role: "Festivals & Annakshetra" },
    ],
    faqs: [
      {
        q: "Is mobile phone allowed inside?",
        a: "Mobile phones, cameras and leather items must be deposited at the free lockers before the security check.",
      },
      {
        q: "How do I book Sugam Darshan?",
        a: "Sugam Darshan tickets can be booked at the trust counter or through our WhatsApp assistance desk; carry a valid photo ID.",
      },
      {
        q: "Is there a dress code?",
        a: "Modest traditional attire is requested. Dhotis are available for men wishing to perform special sevas.",
      },
      {
        q: "Best time to visit?",
        a: "October to March offers pleasant weather. Arrive before 5 AM on Mondays and festival days to avoid long queues.",
      },
    ],
    nearby: [
      "Annapurna Temple (200 m)",
      "Kaal Bhairav Temple (2 km)",
      "Dashashwamedh Ghat (600 m)",
  ...
  },
  {
    ...
    sanskrit: "मीनाक्षी अम्मन मंदिर",
    city: "Madurai",
    state: "Tamil Nadu",
    district: "Madurai",
    category: ["Shakti Peetha", "Ancient", "Heritage"],
    deity: "Goddess Meenakshi & Lord Sundareswarar",
    tradition: "Shaiva-Shakta · Agama (Kamila)",
    image: "/images/Madurai_Meenakshi_Temple.jpg",
    rating: "4.9",
    established: "6th century BCE origins; present structure 12th–17th century",
    trust: "Arulmigu Meenakshi Sundareswarar Thirukkoil",
    summary:
      "A sprawling 14-acre temple city with fourteen gopurams — the beating heart of Tamil devotional culture and the abode of the fish-eyed Goddess.",
    history: [
      "Tradition traces the shrine to the Pandya queen Meenakshi herself. The present complex was expanded by successive Pandyas, Vijayanagara rulers and the Nayaks of Madurai.",
      "The southern gopuram rises 170 feet — among the tallest temple towers in the world — covered with thousands of painted stucco figures narrating Puranic lore.",
    ],
    significance: [
      "Among the foremost Shakti shrines of the South",
      "Thiruvilaiyadal Puranam's 64 divine plays centred here",
      "AAyiram Kaal Mandapam — hall of a thousand pillars",
    ],
    divineAttractions: [
      "Meenakshi Amman darshan",
      "Sundareswarar shrine",
      "Four monumental gopurams",
      "Thousand-Pillar Hall and temple sculpture",
      "Evening Palliyarai ritual atmosphere",
    ],
    scripturalConnections: [
      {
        title: "Thiruvilaiyadal tradition",
        context:
          "Madurai's sacred stories centre on Shiva's divine plays and the royal-divine story of Meenakshi.",
      },
      {
        title: "Tamil devotional literature",
        context:
          "The temple belongs to the long Shaiva devotional culture of Tamil Nadu.",
      },
    ],
    pilgrimExperience: [
      "Morning temple opening",
      "Meenakshi–Sundareswarar darshan",
      "Temple architecture walk",
      "Evening ritual and festival experience",
    ],
    bhagavataConnection: [
      "Madurai's devotional culture is primarily Shaiva-Shakta, while the wider Tamil sacred landscape includes major Vaishnava and Krishna traditions.",
    ],
    sources: [
      {
        ...
        type: "Government",
        purpose:
          "Official temple identity, timings, administration and pilgrim information.",
        lastVerified: "2026-09-14",
      },
    ],
    darshanTimings: [
      { label: "Morning Darshan", time: "5:00 AM – 12:30 PM" },
      { label: "Evening Darshan", time: "4:00 PM – 10:00 PM" },
      { label: "Palliyarai Pooja", time: "9:30 PM" },
    ],
    aarti: [
      {
        name: "Ushakkala Pooja",
        time: "5:30 AM",
        desc: "Dawn worship opening the sanctums.",
      },
      {
        name: "Uchikala Pooja",
        time: "12:00 PM",
        desc: "Midday alankaram and deeparadhana.",
      },
      {
        name: "Arthajama Pooja & Palliyarai",
        time: "9:30 PM",
        desc: "Night procession of Sundareswarar to Meenakshi's chamber.",
      },
    ],
    festivals: [
      {
        ...
        month: "Apr / May",
        desc: "The celestial wedding draws over a million devotees during Chithirai festival.",
      },
      {
        name: "Navaratri",
        month: "Sep / Oct",
        desc: "Nine nights of alankarams; the golden chariot procession on Vijayadashami.",
      },
    ],
    facilities: [
      "Free footwear stands at all four entrances",
      "Temple museum & 1000-pillar hall",
      "Prasadam counters (Puttu, Appam)",
      "Multilingual guides",
      "Wheelchair lanes",
      "Overseas pilgrim helpdesk",
    ],
    howToReach: [
      { mode: "Air", detail: "Madurai Airport (12 km)." },
      { mode: "Rail", detail: "Madurai Junction (1.5 km)." },
      {
        mode: "Road",
        detail: "Central bus stand 2 km; temple zone partly pedestrianised.",
      },
    ],
    committee: [
      { name: "Joint Commissioner", role: "HR & CE Department" },
      { name: "Head Sivachariar", role: "Agamic Rituals" },
    ],
    faqs: [
      {
        q: "Are non-Hindus allowed?",
        a: "All are welcome in the outer corridors and mandapams; sanctum entry follows Agama custom.",
      },
      {
        q: "How long does darshan take?",
        a: "Free darshan 45–90 min at peak; special entry darshan is typically under 30 min.",
      },
    ],
    nearby: [
      "Thiruparankundram Murugan Temple (8 km)",
      "Azhagar Kovil (21 km)",
  ...
  },
  {
    ...
    sanskrit: "श्री केदारनाथ धाम",
    city: "Kedarnath",
    state: "Uttarakhand",
    district: "Rudraprayag",
    category: ["Jyotirlinga", "Char Dham", "Himalayan"],
    deity: "Lord Shiva (Kedareshwar)",
    tradition: "Shaiva · Rawal (Veerashaiva) & Shankaracharya Parampara",
    image: "/images/kedarnath-dham.webp",
    rating: "4.9",
    established: "Legendary antiquity; revived by Adi Shankaracharya (8th c.)",
    trust: "Shri Badrinath–Kedarnath Temple Committee",
    summary:
      "At 3,583 metres amid snow peaks at the head of the Mandakini, Kedarnath is the loftiest Jyotirlinga — the crown of the Char Dham.",
    history: [
      "The Pandavas are said to have sought Shiva here for atonement; the deity dove into the earth, leaving the hump at Kedarnath.",
      "Adi Shankaracharya restored the shrine in the 8th century and attained samadhi just behind it.",
      "The temple survived the devastating 2013 floods — a boulder (Bhim Shila) shielded the sanctum, an event devotees call divine protection.",
    ],
    significance: [
      "Highest of the twelve Jyotirlingas",
      "One of the Char Dham; first among Panch Kedar",
      "Shankaracharya's mahasamadhi sthal",
    ],
    divineAttractions: [
      "Kedarnath Jyotirlinga darshan",
      "Himalayan sunrise over Kedarnath valley",
      "Bhairavnath temple and mountain views",
      "Mandakini river landscape",
      "Shankaracharya samadhi site",
    ],
    scripturalConnections: [
      {
        title: "Skanda / Kedara tradition",
        context:
          "Kedara is celebrated as a major Shaiva kshetra in Himalayan pilgrimage literature.",
      },
      {
        title: "Mahabharata tradition",
        context:
          "The Pandavas' search for Shiva is central to the popular sacred story of Kedarnath.",
      },
    ],
    pilgrimExperience: [
      "Seasonal Himalayan yatra",
      "Dawn darshan",
      "Mandakini valley walk",
      "Kedarnath–Bhairavnath sacred circuit",
    ],
    bhagavataConnection: [
      "The Himalayan pilgrimage route connects with broader Hindu bhakti and sacred geography, including Badrinath and Vaishnava traditions.",
    ],
    sources: [
      {
        title: "Official Kedarnath Information",
        organization: "Shri Badarinath Kedarnath Temple Committee",
        url: "https://badrinath-kedarnath.gov.in/AboutUs/shri-kedarnath.aspx",
        type: "Official Temple",
        purpose:
          "Official temple history, pilgrimage identity and access information.",
        lastVerified: "2026-09-14",
      },
    ],
    darshanTimings: [
      { label: "Morning Darshan", time: "4:00 AM – 12:00 PM (season)" },
      { label: "Evening Darshan", time: "3:00 PM – 9:00 PM (season)" },
      {
        label: "Season",
        time: "Open late-April to early-Nov (dates vary by Akshaya Tritiya / Bhai Dooj)",
      },
    ],
    aarti: [
      {
        ...
        time: "4:00 AM",
        desc: "Pre-dawn abhishek with Vedic Rudram chanting.",
      },
      {
        name: "Sandhya Aarti",
        time: "6:30 PM",
        desc: "Evening aarti against the Himalayan sunset.",
      },
    ],
    festivals: [
      {
        ...
        month: "Apr / May",
        desc: "Doli of Baba Kedar carried from Ukhimath amid army bands and flower showers.",
      },
      {
        name: "Samadhi of Shankaracharya",
        month: "Season",
        desc: "Special prayers at the samadhi shrine behind the temple.",
      },
    ],
    facilities: [
      "GMVN & trust guesthouses (advance booking essential)",
      "Medical relief posts en route",
      "Helicopter services (Phata, Guptkashi, Sirsi)",
      "Pony / palki regulated stands",
      "Free bhandara during season",
    ...
    howToReach: [
      {
        mode: "Trek",
        detail:
          "18 km upgraded trail from Gaurikund (pony, palki, helicopter options).",
      },
      { mode: "Rail", detail: "Rishikesh (215 km) nearest railhead." },
      {
        mode: "Air",
        detail: "Jolly Grant, Dehradun (250 km) + heli shuttles.",
      },
    ],
    committee: [
      { name: "Chairman, BKTC", role: "Temple Administration" },
      { name: "Rawal", role: "Chief Priest (Veerashaiva tradition)" },
    ],
    faqs: [
      {
        q: "When is the temple open?",
        a: "Generally late April to early November. Winter worship continues at Ukhimath (Omkareshwar Temple).",
      },
      {
        q: "Is registration required?",
        a: "Yes — biometric Char Dham registration is mandatory for all pilgrims.",
      },
      {
        q: "Is the trek difficult?",
        a: "Moderate. Acclimatise at Guptkashi/Sonprayag, start early, and carry woollens even in May.",
      },
    ],
    nearby: [
      "Bhairavnath Temple (500 m uphill)",
      "Gandhi Sarovar (3 km)",
      "Vasuki Tal (8 km trek)",
  ...
  },
  {
    ...
    sanskrit: "महाकालेश्वर ज्योतिर्लिंग",
    city: "Ujjain",
    state: "Madhya Pradesh",
    district: "Ujjain",
    category: ["Jyotirlinga", "Shakti Peetha Circuit", "Ancient"],
    deity: "Lord Shiva (Mahakaal — Lord of Time)",
    tradition: "Shaiva · Bhasma-Aarti Parampara",
    image: "/images/mahakaleshwar-jyotirlinga-temple.jpeg",
    rating: "4.9",
    established: "Ancient; rebuilt by Marathas (18th c.)",
    trust: "Shri Mahakaleshwar Temple Management Committee",
    summary:
      "The only south-facing (dakshinamukhi) Jyotirlinga, famed for its pre-dawn Bhasma Aarti — ash worship of Mahakaal on the banks of the Shipra.",
    history: [
      "Ujjayini was among the seven moksha-puris and a seat of Vedic astronomy — the prime meridian of ancient India passed through it.",
      "The present five-level temple was restored under the Marathas; the Mahakal Lok corridor (2022) added 108 sculpted narratives around Rudrasagar lake.",
    ],
    significance: [
      "Dakshinamukhi — the fierce, time-conquering form",
      "Bhasma Aarti: world-famous ash aarti at 4 AM",
      "One of the Sapta Puri (Ujjayini)",
    ],
    divineAttractions: [
      "Mahakaleshwar Jyotirlinga darshan",
      "Bhasma Aarti experience",
      "Mahakal Lok sculptural corridor",
      "Shipra river / Ram Ghat",
      "Kal Bhairav and Harsiddhi sacred circuit",
    ],
    scripturalConnections: [
      {
        title: "Shiva Purana / Jyotirlinga tradition",
        context:
          "Mahakaleshwar is traditionally revered as one of Shiva's twelve Jyotirlingas.",
      },
      {
        title: "Ujjain sacred geography",
        context:
          "Ujjayini is celebrated as a major moksha and temple city in Hindu pilgrimage traditions.",
      },
    ],
    pilgrimExperience: [
      "Pre-dawn Bhasma Aarti planning",
      "Mahakal Lok walk",
      "Ram Ghat river darshan",
      "Ujjain temple circuit",
    ],
    bhagavataConnection: [
      "Ujjain's wider pilgrimage circuit includes Krishna's Sandipani Ashram tradition alongside the Shaiva worship of Mahakaal.",
    ],
    sources: [
      {
        title: "Official District Temple Information",
        ...
        type: "Government",
        purpose:
          "Official pilgrimage and heritage information for Mahakaleshwar.",
        lastVerified: "2026-09-14",
      },
    ],
    darshanTimings: [
      { label: "Bhasma Aarti", time: "4:00 AM – 6:00 AM (ticketed)" },
      { label: "General Darshan", time: "6:00 AM – 11:00 PM" },
    ],
    aarti: [
      {
        name: "Bhasma Aarti",
        time: "4:00 AM",
        desc: "Sacred ash anointment with damru, conch and Vedic hymns. Book 2–4 weeks ahead.",
      },
      {
        name: "Sandhya Aarti",
        time: "7:00 PM",
        desc: "Grand evening aarti with 11 Brahmin priests.",
      },
    ],
    festivals: [
      {
        name: "Mahashivratri",
        month: "Feb / Mar",
        desc: "Nine-day celebration ending with the sehra procession.",
      },
      {
        name: "Simhastha Kumbh",
        month: "Every 12 years",
        desc: "One of four Kumbh sites on the Shipra.",
      },
    ],
    facilities: [
      "Online Bhasma Aarti booking",
      "Mahakal Lok corridor & light-sound show",
      "Laddu prasad counters",
      "Dharamshalas & Annakshetra",
      "Senior-citizen darshan lane",
    ],
    howToReach: [
      { mode: "Air", detail: "Indore Airport (55 km)." },
      { mode: "Rail", detail: "Ujjain Junction (2 km)." },
    ],
    committee: [
      { name: "Collector (Chairman)", role: "Management Committee" },
      { name: "Head Pujari", role: "Bhasma Aarti Rituals" },
    ],
    faqs: [
      {
        q: "How to book Bhasma Aarti?",
        a: "Online via the trust portal with photo ID; reporting at 2:30 AM in dhoti/saree is required.",
      },
      {
        q: "What should I wear?",
        a: "Traditional attire mandatory for Bhasma Aarti; modest dress for general darshan.",
      },
    ],
    nearby: [
      "Harsiddhi Mata (400 m)",
      "Kal Bhairav (8 km)",
  ...
  },
  {
    ...
    sanskrit: "श्री जगन्नाथ मंदिर, पुरी",
    city: "Puri",
    state: "Odisha",
    district: "Puri",
    category: ["Char Dham", "Heritage", "Vaishnava"],
    deity: "Lord Jagannath, Balabhadra & Devi Subhadra",
    tradition: "Vaishnava · Jagannath Culture",
    image: "/images/Shree-Jagannath-Temple.jpg",
    rating: "4.8",
    established: "12th century (Anantavarman Chodaganga)",
    trust: "Shree Jagannatha Temple Administration (SJTA)",
    summary:
      "One of the Char Dham, home of the Lord of the Universe — famed for the Rath Yatra, the Mahaprasad of Ananda Bazaar and the Nilachakra flag ritual.",
    history: [
      "Built by the Eastern Ganga king Anantavarman Chodaganga in the 12th century, the 214-ft curvilinear shikhara dominates Puri's skyline.",
      "The daily Chula-changing of the Nilachakra flag by chula sevaks has continued unbroken for centuries.",
    ],
    significance: [
      "Char Dham (eastern seat)",
      "Rath Yatra — the world's grandest chariot festival",
      "Mahaprasad cooked in seven earthen pots, one atop another",
    ],
    divineAttractions: [
      "Jagannath, Balabhadra and Subhadra darshan",
      "Grand Road and Rath Yatra heritage",
      "Ananda Bazaar Mahaprasad tradition",
      "Gundicha Temple pilgrimage",
      "Sea-facing Puri spiritual landscape",
    ],
    scripturalConnections: [
      {
        title: "Jagannath tradition",
        context:
          "Jagannath is a major Vaishnava deity and one of India's great pilgrimage centres.",
      },
      {
        title: "Skanda / regional Puri traditions",
        context:
          "Puri's sacred geography is described through long-standing temple, festival and pilgrimage traditions.",
      },
    ],
    pilgrimExperience: [
      "Jagannath darshan according to temple rules",
      "Mahaprasad experience where permitted",
      "Grand Road heritage walk",
      "Rath Yatra season pilgrimage",
    ],
    bhagavataConnection: [
      "Jagannath worship is deeply connected with Krishna/Vishnu bhakti and the wider Bhagavata devotional tradition.",
    ],
    sources: [
      {
        ...
        type: "Government",
        purpose:
          "Temple history, pilgrimage importance, festivals and visitor information.",
        lastVerified: "2026-09-14",
      },
    ],
    darshanTimings: [
      { label: "Temple Opening", time: "5:00 AM" },
      {
        ...
        time: "6:00 AM – 9:00 PM (pauses during rituals)",
      },
      { label: "Pahuda (closing)", time: "~10:30 PM" },
    ],
    aarti: [
      {
        name: "Mangala Alati",
        time: "5:30 AM",
        desc: "First lamp-waving before the deities.",
      },
      {
        name: "Sandhya Alati",
        time: "Evening",
    ...
    festivals: [
      {
        name: "Rath Yatra",
        month: "Jun / Jul",
        desc: "Three colossal chariots carry the deities to Gundicha Temple; millions pull the ropes.",
      },
      {
        name: "Snana Purnima",
        month: "Jun",
        desc: "Ceremonial bathing of 108 pitchers; deities then observe Anasara rest.",
      },
    ],
    facilities: [
      "Ananda Bazaar Mahaprasad market",
      "Shoe & mobile stands at gates",
      "Pilgrim rest sheds",
      "SJTA information centre",
    ],
    howToReach: [
      { mode: "Air", detail: "Bhubaneswar Airport (60 km)." },
      { mode: "Rail", detail: "Puri station (3 km)." },
    ],
    committee: [
      { name: "Chief Administrator (SJTA)", role: "Temple Administration" },
      { name: "Gajapati Maharaja", role: "Adya Sevak (first servitor)" },
    ],
    faqs: [
      {
        q: "Who can enter the temple?",
        a: "Practising Hindus may enter the shrine; all visitors can experience Rath Yatra, the Grand Road, Anand Bazaar and the sea-facing rituals.",
      },
      {
        q: "What is Mahaprasad?",
        a: "The 56-bhog cooked in the temple kitchen and sold at Ananda Bazaar — considered the world's largest open-air food offering.",
      },
    ],
    nearby: [
  ...
  },
  {
    ...
    sanskrit: "सोमनाथ ज्योतिर्लिंग",
    city: "Prabhas Patan",
    state: "Gujarat",
    district: "Gir Somnath",
    category: ["Jyotirlinga", "Coastal", "Heritage"],
    deity: "Lord Shiva (Somnath — Lord of the Moon)",
    tradition: "Shaiva · Chalukya Architecture",
    image: "/images/Somnath-Jyotirlinga-Temple.jpg",
    rating: "4.8",
    established: "Ancient; present shrine 1951",
    trust: "Shree Somnath Trust",
    summary:
      "The first Jyotirlinga, rising on the Arabian Sea shore — the eternal shrine that has been rebuilt in devotion after every destruction.",
    history: [
      "Described as the first among Jyotirlingas, Somnath was raided and rebuilt repeatedly across a millennium — a symbol of civilisational resilience.",
      "Sardar Vallabhbhai Patel initiated the modern reconstruction; the present Chalukya-style temple was consecrated in 1951.",
    ],
    significance: [
      "Pratham Jyotirlinga",
      "Bhalka Tirtha nearby — Krishna's departure lila",
      "Triveni Sangam of Hiran, Kapila & Saraswati",
    ],
    divineAttractions: [
      "Somnath Jyotirlinga darshan",
      "Arabian Sea templefront",
      "Temple evening aarti",
      "Jay Somnath light-and-sound experience",
      "Prabhas Patan sacred circuit",
    ],
    scripturalConnections: [
      {
        title: "Jyotirlinga tradition",
        context:
          "Somnath is traditionally revered as the first of Shiva's twelve Jyotirlingas.",
      },
      {
        title: "Prabhasa Kshetra tradition",
        context:
          "Prabhas is an important sacred landscape associated with Shiva and Krishna traditions.",
      },
    ],
    pilgrimExperience: [
      "Morning sea-facing darshan",
      "Aarti by the Arabian Sea",
      "Prabhas Tirtha circuit",
      "Temple heritage and reconstruction story",
    ],
    bhagavataConnection: [
      "Prabhas Patan is closely associated with the sacred geography of Krishna's final earthly journey, making Somnath a distinctive Shiva–Krishna pilgrimage combination.",
    ],
    sources: [
      {
        title: "Official Temple Portal",
        ...
        type: "Official Temple",
        purpose: "Temple history, darshan, aarti and pilgrimage information.",
        lastVerified: "2026-09-14",
      },
    ],
    darshanTimings: [
      { label: "Darshan", time: "6:00 AM – 9:30 PM" },
      { label: "Aarti", time: "7:00 AM · 12:00 PM · 7:00 PM" },
      { label: "Sound & Light Show", time: "8:00 PM (seasonal)" },
    ],
    aarti: [
      {
        name: "Morning / Madhyahna / Sandhya Aarti",
    ...
    festivals: [
      {
        name: "Mahashivratri",
        month: "Feb / Mar",
        desc: "Three-day fair with cultural programmes on the beachfront.",
      },
      {
        name: "Kartik Purnima",
        month: "Nov",
        desc: "Deepotsav along the Somnath seafront.",
      },
    ],
    facilities: [
      "Trust guesthouses (Sagar Darshan, Tirthdham)",
      "Sound & light show",
      "Museum & Prabhas interpretation centre",
      "Wheelchair access",
    ],
    howToReach: [
      { mode: "Air", detail: "Diu (85 km) / Rajkot (200 km)." },
      { mode: "Rail", detail: "Veraval (7 km)." },
    ],
    committee: [
      { name: "Chairman, Shree Somnath Trust", role: "Administration" },
    ],
    faqs: [
      {
        q: "Is there a light & sound show?",
        a: "Yes, 'Jay Somnath' runs each evening (weather permitting) narrating the temple's history.",
      },
    ],
    nearby: [
      "Bhalka Tirtha (5 km)",
  ...
  },
  {
    ...
    sanskrit: "श्री वेंकटेश्वर मंदिर, तिरुमाला",
    city: "Tirumala",
    state: "Andhra Pradesh",
    district: "Tirupati",
    category: ["Vaishnava", "Hill Shrine", "Ancient"],
    deity: "Lord Venkateswara (Balaji)",
    tradition: "Srivaishnava · Vaikhanasa Agama",
    image: "/images/sri-venkateswara-swamy-vaari-temple.jpeg",
    rating: "4.9",
    established: "Antiquity; inscriptions from 9th century",
    trust: "Tirumala Tirupati Devasthanams (TTD)",
    summary:
      "The world's most-visited sacred shrine — the abode of Lord Venkateswara atop the Seshachalam hills, famed for Suprabhatam and Laddu prasadam.",
    history: [
      "Pallava, Chola, Pandya and Vijayanagara kings endowed the shrine; Krishnadevaraya's gold-covered Ananda Nilayam vimana still gleams.",
      "TTD administers one of the world's largest pilgrim ecosystems — free meals, tonsuring, hospitals and Vedic universities.",
    ],
    significance: [
      "Kali Yuga Vaikuntham",
      "Suprabhatam — the dawn hymn heard across India",
      "Hundi offerings funding vast dharmic charities",
    ],
    divineAttractions: [
      "Sri Venkateswara darshan",
      "Ananda Nilayam temple architecture",
      "Swami Pushkarini sacred tank",
      "Varaha Swamy shrine",
      "Tirumala hill viewpoints",
    ],
    scripturalConnections: [
      {
        title: "Venkatachala Mahatmya tradition",
        context:
          "Tirumala is celebrated through the sacred geography and legends of Lord Venkateswara.",
      },
      {
        title: "Bhagavata / Vaishnava bhakti",
        context:
          "The temple's living worship belongs to the wider Krishna–Vishnu devotional tradition of South India.",
      },
    ],
    pilgrimExperience: [
      "Time-slot darshan",
      "Suprabhatam / seva planning",
      "Temple pradakshina where permitted",
      "Tirumala hill and sacred tank circuit",
    ],
    bhagavataConnection: [
      "Venkateswara is worshipped as a form of Vishnu and belongs strongly to the living Vaishnava bhakti world associated with Krishna and Bhagavata traditions.",
    ],
    sources: [
      {
        title: "Official Tirumala Portal",
        organization: "Tirumala Tirupati Devasthanams",
        url: "https://www.tirumala.org/",
        type: "Official Temple",
        purpose: "Current darshan, seva, temple and pilgrim information.",
        lastVerified: "2026-09-14",
      },
    ],
    darshanTimings: [
      { label: "Suprabhatam", time: "3:00 AM" },
      { label: "Sarva Darshan", time: "From ~6:30 AM (time-slot based)" },
      { label: "Ekantha Seva", time: "~1:00 AM (closing)" },
    ],
    aarti: [
      {
        name: "Suprabhatam",
        time: "3:00 AM",
        desc: "Awakening hymn composed by Prativadi Bhayankaram Annan.",
      },
      {
        name: "Thomala Seva",
        time: "3:30 AM",
        desc: "Floral adornment of the Lord.",
      },
      {
        name: "Archana & Darshan",
        time: "4:30 AM onwards",
        desc: "Sahasranama archana before Sarva Darshan.",
      },
    ],
    festivals: [
      {
        name: "Brahmotsavam",
        month: "Sep / Oct",
        desc: "Nine-day festival with Garuda Seva drawing lakhs.",
      },
      {
        name: "Vaikuntha Ekadashi",
        month: "Dec / Jan",
        desc: "Vaikuntha Dwaram opened; massive pilgrim turnout.",
      },
    ],
    facilities: [
      "Time-slot Sarva Darshan & Divya Darshan tokens",
      "Free Anna Prasadam complex",
      "Tonsure halls & baggage centres",
      "TTD guesthouses & hospitals",
      "Alipiri footpath (3,550 steps)",
    ],
    howToReach: [
      { mode: "Air", detail: "Tirupati Airport (40 km)." },
      { mode: "Rail", detail: "Tirupati (22 km uphill)." },
      {
        mode: "Road",
        detail: "TTD buses every few minutes from Tirupati to Tirumala.",
      },
    ],
    committee: [
      { name: "Chairman, TTD Board", role: "Administration" },
      { name: "Executive Officer", role: "Operations" },
    ],
    faqs: [
      {
        q: "Do I need a darshan ticket?",
        a: "Free Sarva Darshan requires a time-slot token; Special Entry (Rs. 300) darshan can be booked online in advance.",
      },
      {
        q: "Where do I get Laddu prasadam?",
        a: "Laddu counters operate near the temple complex on presentation of the darshan ticket.",
      },
    ],
    nearby: [
      "Sri Padmavathi Temple, Tiruchanur (25 km)",
  ...
  },
  {
    ...
    name: "Shri Ramanathaswamy Temple",
    sanskrit: "श्री रामनाथस्वामी मंदिर",
    city: "Rameshwaram",
    state: "Tamil Nadu",
    district: "Ramanathapuram",
    category: ["Jyotirlinga", "Char Dham", "Coastal"],
    deity: "Lord Ramanathaswamy & Goddess Parvathavardhini",
    tradition: "Shaiva · Ramayana Kshetra",
    image: "/images/rameshwaram-jyotirlinga.jpg",
    rating: "4.8",
    established: "Ramayana origins; present structure 12th–19th century",
    trust: "HR & CE Dept., Govt. of Tamil Nadu",
    summary:
      "Where Rama worshipped Shiva before crossing to Lanka — famed for its 1,200-metre pillared corridor, the longest temple corridor on earth.",
    history: [
      "Rama is said to have installed the Ramalingam here; Hanuman brought the Vishwalingam from Kashi — worshipped first to this day.",
      "The Sethupathi kings and later the Nadar community built the magnificent third prakaram corridor with 1,212 carved pillars.",
    ],
    significance: [
      "Southernmost Jyotirlinga; Char Dham (southern seat)",
      "22 sacred theerthams — ritual bathing precedes darshan",
      "Sethu / Ram Setu darshan point at Dhanushkodi",
    ],
    divineAttractions: [
      "Ramanathaswamy Jyotirlinga darshan",
      "22 sacred theerthams",
      "Long pillared temple corridors",
      "Agni Theertham seafront",
      "Dhanushkodi and Ramayana sacred landscape",
    ],
    scripturalConnections: [
      {
        title: "Ramayana tradition",
        context:
          "Rameshwaram is traditionally associated with Rama's worship of Shiva before the Lanka campaign.",
      },
      {
        title: "Jyotirlinga tradition",
        context:
          "Ramanathaswamy is traditionally revered as one of Shiva's twelve Jyotirlingas.",
      },
    ],
    pilgrimExperience: [
      "22-theertham ritual sequence",
      "Jyotirlinga darshan",
      "Temple corridor heritage walk",
      "Dhanushkodi sacred-landscape visit",
    ],
    bhagavataConnection: [
      "The site is primarily Ramayana-Shaiva in character, while the wider Tamil devotional landscape includes the Vaishnava bhakti tradition.",
    ],
    sources: [
      {
        title: "Ramanathaswamy Temple",
        organization:
          "Ramanathapuram District Administration, Government of Tamil Nadu",
        url: "https://ramanathapuram.nic.in/tourist-place/ramanathaswamy-temple/",
        type: "Government",
        purpose:
          "Temple heritage, pilgrimage significance, theerthams and access information.",
        lastVerified: "2026-09-14",
      },
    ],
    darshanTimings: [
      { label: "Theertham Bathing", time: "5:00 AM – 12:00 PM" },
      { label: "Spatika Lingam Darshan", time: "5:00 AM – 6:00 AM" },
      { label: "General Darshan", time: "6:00 AM – 9:00 PM" },
    ],
    aarti: [
      {
        name: "Palliyarai Deepa Aradhana",
        time: "Evening",
        desc: "Lamp worship with Thevaram hymns.",
      },
      {
        name: "Spatika Lingam Pooja",
        time: "5:00 AM",
        desc: "Crystal lingam darshan — arrive before 5 AM.",
      },
    ],
    festivals: [
      {
        ...
        month: "Feb / Mar",
        desc: "Float festival (Theppam) in the temple tank.",
      },
      {
        name: "Ramalinga Prathistha Day",
        month: "Season",
        desc: "Re-enactment of Rama's worship.",
      },
    ],
    facilities: [
      "22-theertham bathing assistance",
      "Locker & dhoti counters",
      "Sea-view mandapams",
      "Guides for corridor history",
    ],
    howToReach: [
      {
        mode: "Rail",
        detail:
          "Rameshwaram station on Pamban island (2 km) — over the iconic sea bridge.",
      },
      { mode: "Road", detail: "170 km from Madurai via NH-87." },
    ],
    committee: [{ name: "Joint Commissioner", role: "HR & CE Administration" }],
    faqs: [
      {
        q: "Must I bathe in all 22 theerthams?",
        a: "It is customary and auspicious; priests assist pilgrims through the wells in about 1–2 hours.",
      },
      {
        q: "Can I visit Dhanushkodi?",
        a: "Yes — shared jeeps run to the ghost town and Ram Setu viewpoint, 20 km away.",
      },
    ],
    nearby: [
...

  {
    ...
    image: "/images/Mallikarjuna-Temple.jpg",
    established:
      "Ancient pilgrimage centre; present temple complex developed over successive dynasties",
    trust: "Srisaila Devasthanam",
    rating: "4.9",
    summary:
      "The sacred Srisailam hill on the Krishna river, where Mallikarjuna and Bhramaramba unite one of the great Shaiva and Shakta pilgrimage traditions.",
    history: [
    ...
    scripturalConnections: [
      {
        ...
        context:
          "The Jyotirlinga tradition connects Shiva's manifestation at Srisailam with the sacred Srisaila mountain.",
      },
      {
        title: "Skanda Purana / Srisaila tradition",
        context:
          "Srisailam is celebrated as an ancient Shaiva kshetra in regional pilgrimage literature.",
      },
    ],
    pilgrimExperience: [
    ...
    howToReach: [
      {
        mode: "Air",
        detail:
          "Nearest major airport access is generally through Hyderabad; road travel continues into the hill region.",
      },
      {
        mode: "Road",
        detail:
          "Well connected by road from Hyderabad, Kurnool and surrounding Andhra/Telangana towns.",
      },
    ],
    committee: [
      {
  ...
  },
  {
    ...
    sanskrit: "श्री ॐकारेश्वर ज्योतिर्लिंग",
    city: "Omkareshwar",
    state: "Madhya Pradesh",
    district: "Khandwa",
    category: ["Jyotirlinga", "Sacred Pilgrimage"],
    ...
    image: "/images/Omkareshwar_Jyotirlinga_Temple.webp",
    ...
    rating: "4.9",
    summary:
      "A Jyotirlinga on Mandhata island in the Narmada, where river, sacred sound and temple worship converge in a dramatic island pilgrimage.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shiva Purana tradition",
        context:
          "Omkareshwar is celebrated within the Jyotirlinga narrative associated with Shiva's sacred manifestations.",
      },
      {
        title: "Narmada Mahatmya tradition",
        context:
          "The Narmada is revered as a sacred river whose pilgrimage culture shapes the Omkareshwar experience.",
      },
    ],
    pilgrimExperience: [
    ...
    howToReach: [
      {
        mode: "Air",
        detail:
          "Indore airport is the principal air gateway; continue by road.",
      },
      {
        mode: "Rail",
        detail:
          "Khandwa and nearby rail connections can be used with onward road travel.",
      },
      {
        mode: "Road",
        detail:
          "Approachable from Indore, Khandwa and major Madhya Pradesh routes.",
      },
    ],
    committee: [
      {
  ...
  },
  {
    ...
    sanskrit: "श्री त्र्यंबकेश्वर ज्योतिर्लिंग",
    city: "Trimbak",
    state: "Maharashtra",
    district: "Nashik",
    category: ["Jyotirlinga", "Sacred Pilgrimage"],
    ...
    image: "/images/Trimbakeshwar_Temple.jpg",
    established: "18th century present temple on an ancient sacred site",
    trust: "Shri Trimbakeshwar Temple Trust",
    rating: "4.9",
    summary:
      "At the foot of Brahmagiri, Trimbakeshwar marks the sacred source region of the Godavari and houses a distinctive Jyotirlinga associated with the Trimurti.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shiva Purana tradition",
        context:
          "The Jyotirlinga tradition associates Shiva's manifestation here with Gautama Rishi and the sacred descent of the Godavari.",
      },
      {
        title: "Nath / regional pilgrimage traditions",
        context:
          "Brahmagiri and nearby tirthas form a dense sacred geography visited by Shaiva pilgrims.",
      },
    ],
    pilgrimExperience: [
      "Kushavarta darshan",
    ...
    howToReach: [
      ...
      },
      {
        mode: "Rail",
        detail:
          "Nashik Road is the principal railhead with onward road travel.",
      },
      {
        mode: "Road",
  ...
  },
  {
    ...
    sanskrit: "श्री भीमाशंकर ज्योतिर्लिंग",
    city: "Bhimashankar",
    state: "Maharashtra",
    district: "Pune",
    category: ["Jyotirlinga", "Sacred Pilgrimage"],
    ...
    image: "/images/Bhimashankar-Jyotirlinga.jpg",
    established:
      "Ancient shrine; present temple includes later medieval and Maratha-period features",
    trust: "Bhimashankar Temple Trust / local administration",
    rating: "4.9",
    summary:
      "A forested Sahyadri Jyotirlinga where ancient Shiva worship meets biodiversity, hill trekking and the source traditions of the Bhima river.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shiva Purana tradition",
        context:
          "The shrine is celebrated within the broader Jyotirlinga tradition and local Bhimashankar legend.",
      },
      {
        title: "Epic visual tradition",
        context:
          "Temple sculpture and iconography preserve scenes connected with Hindu sacred narratives.",
      },
    ],
    pilgrimExperience: [
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Reached by road from Pune, Mumbai and Nashik through the Sahyadri region.",
      },
    ],
    committee: [
      {
  ...
  },
  {
    ...
    sanskrit: "बाबा बैद्यनाथ ज्योतिर्लिंग",
    city: "Deoghar",
    state: "Jharkhand",
    district: "Deoghar",
    category: ["Jyotirlinga", "Sacred Pilgrimage"],
    ...
    image: "/images/Baba-Baidyanath-Jyotirlinga.jpg",
    established:
      "Ancient pilgrimage centre; temple complex reflects multiple historical periods",
    trust: "Baba Baidyanath Temple administration",
    rating: "4.9",
    summary:
      "The Deoghar Jyotirlinga, revered in eastern India, where intense Shiva devotion meets the Kanwar pilgrimage and a historic temple cluster.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shiva Purana / Jyotirlinga tradition",
        context:
          "Baidyanath is counted among Shiva's twelve Jyotirlinga manifestations in traditional pilgrimage literature.",
      },
      {
        title: "Ravana legend",
        context:
          "Local sacred tradition connects the shrine with Ravana's intense worship of Shiva.",
      },
    ],
    pilgrimExperience: [
      "Shravan pilgrimage",
    ...
    howToReach: [
      ...
      },
      {
        mode: "Road",
        detail:
          "Well connected by road with Jharkhand and Bihar pilgrimage circuits.",
      },
    ],
    committee: [
      {
  ...
  },
  {
    ...
    sanskrit: "श्री नागेश्वर ज्योतिर्लिंग",
    city: "Dwarka",
    state: "Gujarat",
    ...
    image: "/images/Shri-Nageshwar-Jyotirlinga.JPG",
    established:
      "Ancient shrine tradition; present temple developed in modern pilgrimage era",
    trust: "Nageshwar Temple administration",
    rating: "4.9",
    summary:
      "A coastal Shiva shrine on the Dwarka pilgrimage route, where Jyotirlinga worship is paired naturally with Krishna's sacred city and Arabian Sea landscapes.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shiva Purana tradition",
        context:
          "The Nageshwar story is included in traditional Jyotirlinga pilgrimage narratives.",
      },
      {
        title: "Dwarka sacred geography",
        context:
          "The shrine forms a Shaiva complement to the Vaishnava pilgrimage of Dwarka.",
      },
    ],
    pilgrimExperience: [
    ...
    howToReach: [
      {
        mode: "Air",
        detail:
          "Jamnagar is a major air gateway; Porbandar also serves the broader Saurashtra region.",
      },
      {
        mode: "Rail",
        detail:
          "Dwarka railway station is the principal rail access for the circuit.",
      },
      {
        mode: "Road",
        detail:
          "Connected by road with Dwarka and Gujarat's coastal pilgrimage corridor.",
      },
    ],
    committee: [
      {
  ...
  },
  {
    ...
    image: "/images/Grishneshwar-Jyotirlinga.jpeg",
    established:
      "Ancient shrine tradition; present temple rebuilt in the 18th century",
    trust: "Shri Grishneshwar Temple administration",
    rating: "4.9",
    summary:
      "The final Jyotirlinga in the commonly followed list, set beside the monumental Ellora cave complex and the sacred landscape of western Maharashtra.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shiva Purana tradition",
        context:
          "The shrine's popular legend centres on devotion, perseverance and Shiva's grace through the story of Ghushma.",
      },
      {
        title: "Ellora sacred landscape",
        context:
          "The temple sits within a region where Hindu, Buddhist and Jain cave traditions coexist, making the journey both spiritual and heritage-rich.",
      },
    ],
    pilgrimExperience: [
    ...
    howToReach: [
      {
        mode: "Air",
        detail:
          "Chhatrapati Sambhajinagar airport is the closest major air gateway.",
      },
      {
        mode: "Rail",
        detail:
          "Chhatrapati Sambhajinagar railway station provides regional access.",
      },
      {
        mode: "Road",
        detail:
          "Located near Ellora on the road network from Chhatrapati Sambhajinagar.",
      },
    ],
    committee: [
      {
...

  {
    ...
    district: "Anantnag",
    country: "India",
    category: ["Shakti Peetha", "Shakta", "Sacred Pilgrimage"],
    deity: "Maa Mahamaya (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Maa-Mahamaya.jpeg",
    rating: "4.9",
    ...
    summary:
      "Maa Mahamaya, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Amarnath. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        ...
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated throat, Devi name Maa Mahamaya and Bhairava Trisandhyasvar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
          "The site is best understood through Shakti worship, local temple tradition and sacred geography; exact historical identifications vary by source.",
      },
    ],
    pilgrimExperience: [
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Amarnath; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
          "Use the nearest regional airport or railway station, followed by local road transport.",
      },
    ],
    committee: [
      {
    ...
    sources: [
      {
        ...
        type: "Reference",
        purpose:
          "Traditional Peetha number, Devi name, Bhairava and associated Sati body-part identification.",
        lastVerified: "2026-09-14",
      },
    ],
    contentNote:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Maa-Phullara.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Phullara, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Attahasa. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated lower lip, Devi name Maa Phullara and Bhairava Vishwesh.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Attahasa; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Maa-Bahula.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Bahula, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Ketugram / Bardhaman. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left arm, Devi name Maa Bahula and Bhairava Bhiruk.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Ketugram / Bardhaman; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Maa-Mahishmardini.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Mahishmardini, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Bakreshwar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated portion between the eyebrows, Devi name Maa Mahishmardini and Bhairava Vakranath.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Bakreshwar; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Maa-Avanti.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Avanti, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Bhairavparvat, Ujjain. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated elbow / upper lip (debated), Devi name Maa Avanti and Bhairava Lambakarna.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    bhairava: "Lambakarna",
    identificationNote:
      "Traditional 51-Peetha compilation. Body-part and location identifications can vary between Shakta texts and regional traditions. This particular body-part attribution is explicitly debated in the source tradition.",
    darshanTimings: [
      {
        label: "Darshan",
        time: "Current local temple schedule — verify before travel",
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Bhairavparvat, Ujjain; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Maa-Aparna.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Aparna, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Bhavanipur. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated anklet / left chest / right eye (debated), Devi name Maa Aparna and Bhairava Vaman.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Bhavanipur; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
          "Cross-border, permit, ferry or local access rules can apply; verify current requirements before departure.",
      },
    ],
    committee: [
      {
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image:"/images/Gandaki-Chandi-Muktinath-shaktipeeth-temple.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Gandaki Chandi, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Chandi River / Gandaki region. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated cheek, Devi name Gandaki Chandi and Bhairava Chakrapani.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Chandi River / Gandaki region; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Maa-Bhramari.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Bhramari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Janasthaan, Nashik. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated chin, Devi name Maa Bhramari and Bhairava Vikritaksh.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Janasthaan, Nashik; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Hinglaj.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Mata Hinglaj, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Hinglaj, Balochistan. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated head / brahmarandhra, Devi name Mata Hinglaj and Bhairava Bhimalochana.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Hinglaj, Balochistan; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Jayanti-Shakti.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Jayanti Shakti, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Nartiang. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left thigh, Devi name Jayanti Shakti and Bhairava Kamadishwar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Nartiang; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Jeshoreshwari",
    sanskrit: "माता जेशोरेश्वरी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Jeshoreshwari.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Jeshoreshwari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Satkhira / Khulna region. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated palm, Devi name Jeshoreshwari and Bhairava Chanda.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Satkhira / Khulna region; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Siddhida",
    sanskrit: "माता सिद्धिदा",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Siddhida.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Siddhida, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Jwalamukhi, Kangra. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated tongue, Devi name Siddhida and Bhairava Unmatta Bhairava.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Jwalamukhi, Kangra; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Dakshina Kali",
    sanskrit: "माता दक्षिणा काली",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Dakshina-Kali.webp",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Dakshina Kali, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Kalighat, Kolkata. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right toes, Devi name Dakshina Kali and Bhairava Nakuleshwar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Kalighat, Kolkata; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Kalmadhava",
    sanskrit: "माता कालमाधव",
    city: "Amarkantak",
    state: "Madhya Pradesh",
    district: "Anuppur",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Kalmadhava.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Kalmadhava, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Amarkantak. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left buttock, Devi name Kalmadhava and Bhairava Asitananda.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Amarkantak; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Kamakhya",
    sanskrit: "माता कामाख्या",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Kamakhya.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Kamakhya, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Guwahati / Nilachal Hill. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated yoni, Devi name Maa Kamakhya and Bhairava —.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Guwahati / Nilachal Hill; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Devgarbha",
    sanskrit: "माता देवगर्भा",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image:"/images/Shakti-Peetha-Mata-Devgarbha.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Devgarbha, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Kankalitala region. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated bones, Devi name Devgarbha and Bhairava Ruru.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Kankalitala region; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Sravani",
    sanskrit: "माता श्रावणी",
    city: "Kanyakumari",
    state: "Tamil Nadu",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Sravani.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Sravani, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Kanyakumari. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated back and spine, Devi name Sravani and Bhairava Nimish.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Kanyakumari; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Chamundeshwari",
    sanskrit: "माता चामुंडेश्वरी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image:"/images/Shakti-Peetha- Mata-Chamundeshwari.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Chamundeshwari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Chamundi Hills, Mysuru. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated hair, Devi name Chamundeshwari and Bhairava Bheeshan Bhairava.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Chamundi Hills, Mysuru; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Vimla / Kiriteshwari",
    sanskrit: "माता विमला / किरीटेश्वरी",
    city: "Murshidabad",
    state: "West Bengal",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Vimla-Kiriteshwari.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Vimla / Kiriteshwari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Murshidabad. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated crown, Devi name Vimla / Kiriteshwari and Bhairava Samvarta.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Murshidabad; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Kumari",
    sanskrit: "माता कुमारी",
    ...
    deity: "Kumari (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Kumari.webp",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Kumari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Anandamayee Temple region. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right shoulder, Devi name Kumari and Bhairava Bhairava.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Anandamayee Temple region; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Bhraamri Devi",
    sanskrit: "माता भ्रामरी देवी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Bhraamri-Devi.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Bhraamri Devi, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Bodaganj, Jalpaiguri. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left leg, Devi name Bhraamri Devi and Bhairava Iswar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Bodaganj, Jalpaiguri; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Dakshayani / Manasa",
    sanskrit: "माता दाक्षायनी / मनसा",
    city: "Manasarovar",
    state: "Tibet",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Dakshayani-Manasa.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Dakshayani / Manasa, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Manasarovar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right hand, Devi name Dakshayani / Manasa and Bhairava Amar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Manasarovar; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Gayatri / Chamunda",
    sanskrit: "माता गायत्री / चामुंडा",
    city: "Pushkar",
    state: "Rajasthan",
    district: "Ajmer",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Gayatri-Chamunda.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Gayatri / Chamunda, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Pushkar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated wrist / bracelet, Devi name Gayatri / Chamunda and Bhairava Sharvananda.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Pushkar; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Uma Devi",
    sanskrit: "माता उमा देवी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Uma-Devi.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Uma Devi, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Mithila, India–Nepal border. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left shoulder, Devi name Uma Devi and Bhairava Mahodar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Mithila, India–Nepal border; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Nagapooshani",
    sanskrit: "माता नागपूशनी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Nagapooshani.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Nagapooshani, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Nainativu, Jaffna. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated anklets, Devi name Nagapooshani and Bhairava Nayinaar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Nainativu, Jaffna; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata  Mahashira",
    sanskrit: "माता महाशिरा",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Mahashira.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Mahashira, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Guhyeshwari, Kathmandu. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated hips, Devi name Mahashira and Bhairava Kapali.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Guhyeshwari, Kathmandu; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Bhavani",
    sanskrit: "माता भवानी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Bhavani.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Bhavani, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Chandranath Hills. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right arm, Devi name Bhavani and Bhairava Chandrashekhar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Chandranath Hills; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Varahi",
    sanskrit: "Varahi",
    city: "Panch Sagar",
    state: "Uttar Pradesh",
    district: "Varanasi",
    ...
    deity: "Varahi (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Varahi.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Varahi, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Panch Sagar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated lower teeth, Devi name Varahi and Bhairava Maharudra.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Panch Sagar; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Chandrabagha",
    sanskrit: "माता चंद्रबाघा",
    city: "Junagadh",
    state: "Gujarat",
    district: "Junagadh",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Chandrabagha.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Chandrabagha, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Junagadh. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated stomach, Devi name Chandrabagha and Bhairava Vakratund.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Junagadh; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Lalita",
    sanskrit: "माता ललिता",
    ...
    deity: "Lalita (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Lalita.png",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Lalita, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Prayag / Prayagraj. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated fingers, Devi name Lalita and Bhairava Benimadhav.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Prayag / Prayagraj; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Savitri / Bhadra Kali",
    sanskrit: "माता सावित्री / भद्र काली",
    city: "Kurukshetra",
    state: "Haryana",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Mata-Savitri-Bhadra-Kali.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Savitri / Bhadra Kali, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Kurukshetra. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right ankle, Devi name Savitri / Bhadra Kali and Bhairava Sthanu Mahadev.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Kurukshetra; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Maihar / Shivani",
    sanskrit: "माता मैहर / शिवानी",
    city: "Maihar",
    state: "Madhya Pradesh",
    district: "Satna",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/shakti-peetha-32-maihar-shivani-maihar.svg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maihar / Shivani, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Maihar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated breast, Devi name Maihar / Shivani and Bhairava Canda.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Maihar; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Nandini",
    sanskrit: "माता नंदिनी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image:"/images/Shakti-Peetha-Mata-Nandini.svg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Nandini, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Nandikeshwari, Birbhum. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated necklace, Devi name Nandini and Bhairava Nandikeshwar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Nandikeshwari, Birbhum; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Vishweshwari / Rakini / Viswamatuka",
    sanskrit: "माता विश्वेश्वरी / राकिनी / विश्वमतुका",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image:"/images/Shakti-Peetha-Mata-Vishweshwari-Rakini-Viswamatuka.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Vishweshwari / Rakini / Viswamatuka, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Kotilingeswar region, Godavari. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left cheek, Devi name Vishweshwari / Rakini / Viswamatuka and Bhairava Vatsnabh / Dandapani.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Kotilingeswar region, Godavari; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Mahishasuramardini",
    sanskrit: "माता महिषासुरमर्दिनी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image:"/images/Shakti-Peetha-Mata-Mahishasuramardini.svg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Mahishasuramardini, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Shivaharkaray, Karachi. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated third eye, Devi name Mahishasuramardini and Bhairava Krodish.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Shivaharkaray, Karachi; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Narmada",
    sanskrit: "माता नर्मदा",
    city: "Amarkantak",
    state: "Madhya Pradesh",
    district: "Anuppur",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Narmada.svg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Narmada, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Amarkantak. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right buttock, Devi name Narmada and Bhairava Bhadrasen.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Bhramaramba Devi / Sri Sundari",
    sanskrit: "माता भ्रामराम्बा देवी / श्री सुंदरी",
    city: "Srisailam",
    state: "Andhra Pradesh",
    district: "Nandyal",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Bhramaramba-Devi-Sri-Sundari.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Bhramaramba Devi / SriSundari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Srisailam. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right anklet, Devi name Bhramaramba Devi / SriSundari and Bhairava Sundarananda.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Srisailam; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Mahalaksmi",
    sanskrit: "माता महालक्ष्मी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Mahalaksmi.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Mahalaksmi, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Sri Shail / Sylhet region. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated neck, Devi name Mahalaksmi and Bhairava Sambaranand.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Sri Shail / Sylhet region; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Narayani / Kanya Kumari / Bhagavathy Amman",
    sanskrit: "माता नारायणी / कन्या कुमारी / भगवती अम्मन",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image:"/images/Shakti-Peetha-Mata- Narayani-Kanya-Kumari-Bhagavathy-Amman.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Maa Narayani / Kanya Kumari / Bhagavathy Amman, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Suchindram / Kanyakumari region. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated upper teeth, Devi name Maa Narayani / Kanya Kumari / Bhagavathy Amman and Bhairava Sangharor Samhara.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Suchindram / Kanyakumari region; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata sugandha",
    sanskrit: "माता सुगंधा",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Sunanda.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Sunanda, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Shikarpur, Barishal. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated nose, Devi name Sunanda and Bhairava Traimbak.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Shikarpur, Barishal; local access conditions should be checked before travel.",
      },
      {
        mode: "Travel planning",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Tripura Sundari",
    sanskrit: "माता त्रिपुर सुंदरी",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Tripura-Sundari.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Tripura Sundari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Udaipur, Tripura. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right foot, Devi name Tripura Sundari and Bhairava Tripuresh.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Udaipur, Tripura; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Mangal Chandika",
    sanskrit: "माता मंगल चंडिका",
    city: "Ujaani",
    state: "West Bengal",
    district: "Purba Bardhaman",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Mangal-Chandika.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Mangal Chandika, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Ujaani. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated right wrist, Devi name Mangal Chandika and Bhairava Kapilambar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Ujaani; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Vishalakshi",
    sanskrit: "माता विशालाक्षी",
    city: "Varanasi",
    state: "Uttar Pradesh",
    district: "Varanasi",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Vishalakshi.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Vishalakshi, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Varanasi. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated earring, Devi name Vishalakshi and Bhairava Kaal Bhairava.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Varanasi; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Kapalini / Kali Maa",
    sanskrit: "माता कपालिनी / काली माँ",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Kapalini-Kali-Maa.webp",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Kapalini / Kali Maa, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Vibash / Medinipur region. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left ankle, Devi name Kapalini / Kali Maa and Bhairava Sarvananda.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Vibash / Medinipur region; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Ambika",
    sanskrit: "माता अंबिका",
    city: "Bharatpur",
    state: "Rajasthan",
    district: "Bharatpur",
    country: "India",
    ...
    deity: "Ambika (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Ambika.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Ambika, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Bharatpur. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
      "According to the traditional Shakti Peetha narrative, the left leg of Sati is associated with this Peetha.",
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left leg, Devi name Ambika and Bhairava Amriteshwar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Bharatpur; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    deity: "Uma (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Uma-katyayani-bhooteshwar-Shaktipeeth.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Uma, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Vrindavan / Bhuteshwar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
      "According to the traditional Shakti Peetha narrative, the hair of Sati is associated with this Peetha.",
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated hair, Devi name Uma and Bhairava Bhuteshwar.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Vrindavan / Bhuteshwar; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Tripuramalini",
    sanskrit: "माता त्रिपुरमालिनी",
    city: "Jalandhar",
    state: "Punjab",
    district: "Jalandhar",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Tripuramalini.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Tripuramalini, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Jalandhar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated left breast, Devi name Tripuramalini and Bhairava Bhishan.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Jalandhar; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    deity: "Amba (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Amba.webp",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Amba, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Ambaji. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated heart, Devi name Amba and Bhairava Batuk Bhairav.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Ambaji; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Jai Maa Durga",
    sanskrit: "जय माँ दुर्गा",
    city: "Deoghar",
    state: "Jharkhand",
    district: "Deoghar",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Jai-Maa-Durga.svg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Jai Durga, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Deoghar. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated ears, Devi name Jai Durga and Bhairava Vaidyanath.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Deoghar; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Danteshwari",
    sanskrit: "माता दंतेश्वरी",
    city: "Dantewada",
    state: "Chhattisgarh",
    district: "Dantewada",
    country: "India",
    ...
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Danteshwari.jpg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Danteshwari, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Dantewada. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated tooth, Devi name Danteshwari and Bhairava Kapalbhairava.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Dantewada; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
  ...
  },
  {
    ...
    name: "Shakti Peetha — Mata Biraja",
    sanskrit: "माता बिरजा",
    city: "Jajpur",
    state: "Odisha",
    district: "Jajpur",
    ...
    deity: "Biraja (Shakti)",
    tradition: "Shakta · Traditional Shakti Peetha",
    image: "/images/Shakti-Peetha-Mata-Biraja.jpeg",
    rating: "4.9",
    established: "Ancient sacred tradition; present temple form varies by site",
    trust: "Local temple / regional religious administration",
    summary:
      "Biraja, worshipped here as a manifestation of Shakti, is traditionally associated with this sacred Peetha at Jajpur. The site combines Devi worship, regional pilgrimage culture and a distinct sacred landscape for travellers.",
    history: [
    ...
    scripturalConnections: [
      {
        title: "Shakta Peetha tradition",
        context:
          "The Peetha is recorded in traditional Shakta compilations with Sati's associated navel, Devi name Biraja and Bhairava Varaha.",
      },
      {
        title: "Devi-centered pilgrimage",
        context:
    ...
    howToReach: [
      {
        mode: "Road",
        detail:
          "Approach from the main town / district around Jajpur; local access conditions should be checked before travel.",
      },
      {
        mode: "Air / Rail",
        detail:
...
export const SHAKTI_PEETHA_DATA = TEMPLE_DATA.filter((temple) =>
  temple.category.includes("Shakti Peetha"),
);
